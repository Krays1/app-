...
console.log('Testing Snake server functionality (direct)...');
...
socket.on('connect', () => {
    ...
    // Test 1: Get leaderboard directly
    console.log('🏆 Getting leaderboard directly...');
...
socket.on('snake:submit_result', (data) => {
    ...
    if (data.success) {
        ...
        console.log('🏆 Getting updated leaderboard...');
        socket.emit('snake:get_leaderboard');
    } else {
